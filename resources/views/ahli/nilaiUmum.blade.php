            ...
            <div class="col-md-3">
                <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <p class="card-text"> <button class="btn btn-success w-100">Nilai Ahli</button> </p>
                        <i class="card-link">Nilai :</i>
                        <a href="nilai_ahli/add/{{$k->m_kelas_id}}?guru={{Auth::id()}}&mapel={{$k->mapel[0]->id}}&smt={{$k->kelas[0]->tahun.'1'}}" class="card-link">Ganjil</a>
                        <a href="nilai_ahli/add/{{$k->m_kelas_id}}?guru={{Auth::id()}}&mapel={{$k->mapel[0]->id}}&smt={{$k->kelas[0]->tahun.'2'}}" class="card-link">Genap</a>
                    </div>                   
                </div>
            </div>
            @endforeach
